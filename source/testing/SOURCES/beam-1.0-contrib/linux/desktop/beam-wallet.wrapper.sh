...
# This sets some needed environment variables and allows for some
# experimentation. Why? Because, for example, QT5 + GNOME + Wayland do not work
# well just yet, unfortunately. So, we, by default failback to x11. 
...
# Note: beam.desktop will call this script instead of the raw beam-wallet
# executable.
...
XDG_SESSION_TYPE=$_XDG_SESSION_TYPE QT_QPA_PLATFORM=$_QT_QPA_PLATFORM /usr/bin/env beam-wallet ${1}
